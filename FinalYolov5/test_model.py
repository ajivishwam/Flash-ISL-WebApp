...
# Configuration
model_path = 'C:/Users/Avishwa/Flask-app/FinalYolov5/trained_model/last.pt'
resize_size = (256, 256)  # Resize images to 256x256
output_path = 'C:/Users/Avishwa/Flask-app/static/annotated_results'  # Directory to save results
language_code = 'hi'  # Default translation language
...
def text_to_speech(text, file_path):
    ...
    tts = gTTS(text=text, lang='en')  # Use 'en' for English, adjust as needed
    tts.save(file_path)
...
def process_frame(frame):
    ...
    for *box, conf, cls in detections:
        ...
        translated_text = translate_text(model.names[int(cls)], language_code)
        ...
        cv2.rectangle(frame, (x1, label_y1 - label_size[1]), (x1 + label_size[0], label_y1), (0, 255, 0), -1)  # Background rectangle for label
        cv2.putText(frame, label, (x1, label_y1), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 0), 1)  # Label text
...
def run_webcam():
    ...
    while True:
        ...
        cv2.imshow('Webcam YOLO Detection', processed_frame)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Run YOLO model')
